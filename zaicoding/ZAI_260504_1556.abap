...
DATA gv_budat TYPE mkpf-budat.
SELECT-OPTIONS s_budat FOR gv_budat OBLIGATORY.
...
CLASS lcl_app IMPLEMENTATION.
  METHOD run.
    ...
    " Materials with movements in plant/date
    ...
    " Finished goods having BOM in plant
    ...
    " BOM component materials in plant
